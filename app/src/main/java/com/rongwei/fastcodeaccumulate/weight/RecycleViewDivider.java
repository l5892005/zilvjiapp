package com.rongwei.fastcodeaccumulate.weight;
...
public class RecycleViewDivider extends RecyclerView.ItemDecoration {
     ...
     * @param context
     */
    public RecycleViewDivider(int colorId, Context context) {
        this(context, LinearLayoutManager.VERTICAL, SizeUtils.dp2px(0.5f), 0, 0, context.getResources().getColor(colorId));
    }
     ...
     * @param context
     */
    public RecycleViewDivider(Context context, String color) {
        this(context, LinearLayoutManager.VERTICAL, SizeUtils.dp2px(0.5f), 0, 0, Color.parseColor(color));
    }
