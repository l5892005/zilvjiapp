...
import com.rongwei.fastcodeaccumulate.injector.components.DaggerUserAgreementComponent;
...
public class UserAgreementActivity extends ToolbarActivity implements UserAgreementContract.View {

    @Inject
    UserAgreementContract.Presenter mPresenter;
    ...
    protected void initInjector() {
        DaggerUserAgreementComponent
                .builder()
                .applicationComponent(AndroidApplication.getInstance().getAppComponent())
                .userAgreementModule(new UserAgreementModule(this))
                .build()
                .inject(this);
    }
    String userAgreement=
            ...
            "\n" +
            "如对本《隐私政策》或相关事宜有任何问题，526502173@qq.com与我们联系。\n" +
            "\n" +
            "我们可能收集的信息\n" +
            "\n" +
