...
//    }
    ...
    public static void d(Object object, final Object... contents) {
        log(D, object, contents);
    }
...
//    }
    ...
    public static void i(Object object, final Object... contents) {
        log(I, object, contents);
    }
...
//    }
    ...
    public static void w(Object object, final Object... contents) {
        log(W, object, contents);
    }
...
//    }
    ...
    public static void e(Object object, final Object... contents) {
        log(E, object, contents);
    }
...
//    }
    ...
    public static void a(Object object, final Object... contents) {
        log(A, object, contents);
    }
    ...
    public static void json(final String content) {
        log(JSON | D, "JSON", content);
    }

    public static void json(Object object, final String content) {
        log(JSON | D, object, content);
    }

    public static void json(@TYPE final int type, final String content) {
        log(JSON | type, "JSON", content);
    }
    ...
    public static void log(final int type, final Object object, final Object... contents) {
        if (object instanceof String) {
            log(type, (String) object, contents);
        } else {
            log(type, object.getClass().getSimpleName(), contents);
        }
    }
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = AndroidApplication.getInstance().getApplicationContext()
                    .getPackageManager()
                    .getPackageInfo(AndroidApplication.getInstance().getApplicationContext().getPackageName(), 0);
            if (pi != null) {
    ...
    public static class Config {
        ...
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && AndroidApplication.getInstance().getApplicationContext().getExternalCacheDir() != null)
                mDefaultDir = AndroidApplication.getInstance().getApplicationContext().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                mDefaultDir = AndroidApplication.getInstance().getApplicationContext().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
        ...
        public Config setRelease(final boolean release) {
