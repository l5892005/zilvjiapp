...
public class EncryptUtils {
    ...
    public static byte[] decryptBase64DES(final byte[] data,
                                          final byte[] key,
                                          final String transformation,
                                          final byte[] iv) throws UnsupportedEncodingException {
    ...
    public static byte[] decryptBase64RSA(final byte[] data,
                                          final byte[] key,
                                          final boolean isPublicKey,
                                          final String transformation) throws UnsupportedEncodingException {
    ...
    private static byte[] base64Decode(final byte[] input) throws UnsupportedEncodingException {
        return EncodeUtils.base64Decode(input.toString());
    }
