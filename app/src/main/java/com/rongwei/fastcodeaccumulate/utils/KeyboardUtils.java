...
public class KeyboardUtils {
    ...
    public static void showSoftInput(final View view) {
        InputMethodManager imm =
                (InputMethodManager) AndroidApplication.getInstance().getApplicationContext().getSystemService(Context.INPUT_METHOD_SERVICE);
        if (imm == null) return;
        view.setFocusable(true);
        view.setFocusableInTouchMode(true);
        view.requestFocus();
    ...
    public static void hideSoftInput(final View view) {
        if (view!=null){
            InputMethodManager imm = (InputMethodManager) AndroidApplication.getInstance().getApplicationContext().getSystemService(Context.INPUT_METHOD_SERVICE);
            if (imm == null) return;
            imm.hideSoftInputFromWindow(view.getWindowToken(), 0);
        }
    }
...
//        LogUtils.d(contentView.getTop(), contentView.getBottom(), outRect.top, outRect.bottom);
    ...
    public static void clickBlankArea2HideSoftInput() {
        LogUtils.iTag("KeyboardUtils", "Please refer to the following code.");
        /*
        @Override
