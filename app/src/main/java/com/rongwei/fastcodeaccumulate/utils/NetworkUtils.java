...
public class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        AndroidApplication.getInstance().startActivity(
...
//    }
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) AndroidApplication.getInstance().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) AndroidApplication.getInstance().getSystemService(Context.WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) AndroidApplication.getInstance().getSystemService(Context.CONNECTIVITY_SERVICE);
        return cm != null
